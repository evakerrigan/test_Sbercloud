      ...
      >
        {({ touched, errors }) => (
          ...
          <Form className="form">
            ...
            <div id="button-add" className="step2__button-add">+</div>

            <div id="checkbox-group" className="checkbox__title">Checkbox group</div>
            <div role="group" aria-labelledby="checkbox-group">
              <label className="form__checkbox">
                <Field id="field-checkbox-group-option-1" type="checkbox" name="checked" value="1" />
                1
              </label>
              <label className="form__checkbox">
                <Field id="field-checkbox-group-option-2" type="checkbox" name="checked" value="2" />
                2
              </label>
              <label className="form__checkbox">
                <Field id="field-checkbox-group-option-3" type="checkbox" name="checked" value="3" />
                3
              </label>
            </div>

            <div id="my-radio-group" className="radio__title">Radio group</div>
            <div role="group" aria-labelledby="my-radio-group">
              <label className="form__radio">
                <Field id="field-radio-group-option-1" type="radio" name="picked" value="1" />
                1
              </label>
              <label className="form__radio">
                <Field id="field-radio-group-option-2" type="radio" name="picked" value="2" />
                2
              </label>
              <label className="form__radio">
                <Field id="field-radio-group-option-3" type="radio" name="picked" value="3" />
                3
              </label>
            </div>
