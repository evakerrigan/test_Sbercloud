  ...
  return (
    <div className="modal">
      <div className="modal__content error">
        ...
        <button id="button-close" className="form__button next" onClick={() => setActive(false)}>Закрыть</button>
  ...
  return (
    <div className="modal">
      <div className="modal__content success">
        ...
        <Link id="button-to-main" className="form__button next" to="/">На главную</Link>
      </div>
    </div>
  );
